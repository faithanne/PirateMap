...
public class MainActivity extends FragmentActivity implements
	...
	public void addCourse(View view) {
		...
		final View dialogView = inflater.inflate(R.layout.dialog_course_entry,
				null);
		...
		builder.setPositiveButton(getString(R.string.add),
				new DialogInterface.OnClickListener() {
					...
					public void onClick(DialogInterface dialog, int which) {
						...
						String coursePrefix = ((Spinner) dialogView
								.findViewById(R.id.course_prefix_spinner))
								.getSelectedItem().toString();
						String courseNumber = ((EditText) dialogView
								.findViewById(R.id.course_number_edittext))
								.getText().toString();
						String coursePostfix = ((Spinner) dialogView
								.findViewById(R.id.course_postfix_spinner))
								.getSelectedItem().toString();

						String building = ((Spinner) dialogView
								.findViewById(R.id.building_name_spinner))
								.getSelectedItem().toString();

						String roomNumber = ((EditText) dialogView
								.findViewById(R.id.course_room_edittext))
								.getText().toString();
						String roomPostfix = ((Spinner) dialogView
								.findViewById(R.id.room_postfix_spinner))
								.getSelectedItem().toString();

						String professor = ((EditText) dialogView
								.findViewById(R.id.course_professor_edittext))
								.getText().toString();

						String startHour = ((Spinner) dialogView
								.findViewById(R.id.start_hour_spinner))
								.getSelectedItem().toString();
						String startMinute = ((Spinner) dialogView
								.findViewById(R.id.start_minute_spinner))
								.getSelectedItem().toString();
						String startAmPm = ((Spinner) dialogView
								.findViewById(R.id.start_am_pm_spinner))
								.getSelectedItem().toString();

						String endHour = ((Spinner) dialogView
								.findViewById(R.id.end_hour_spinner))
								.getSelectedItem().toString();
						String endMinute = ((Spinner) dialogView
								.findViewById(R.id.end_minute_spinner))
								.getSelectedItem().toString();
						String endAmPm = ((Spinner) dialogView
								.findViewById(R.id.end_am_pm_spinner))
								.getSelectedItem().toString();

						String days = "";

						CheckBox mCheckBox = (CheckBox) dialogView
								.findViewById(R.id.m_checkedtext);
						if (mCheckBox != null && mCheckBox.isChecked()) {
							days += "M";
						}

						CheckBox tCheckBox = (CheckBox) dialogView
								.findViewById(R.id.t_checkedtext);
						if (tCheckBox != null && tCheckBox.isChecked()) {
							days += "T";
						}

						CheckBox wCheckBox = (CheckBox) dialogView
								.findViewById(R.id.w_checkedtext);
						if (wCheckBox != null && wCheckBox.isChecked()) {
							days += "W";
						}

						CheckBox hCheckBox = (CheckBox) dialogView
								.findViewById(R.id.h_checkedtext);
						if (hCheckBox != null && hCheckBox.isChecked()) {
							days += "H";
						}

						CheckBox fCheckBox = (CheckBox) dialogView
								.findViewById(R.id.f_checkedtext);
						if (fCheckBox != null && fCheckBox.isChecked()) {
							days += "F";
						}

						Course course = new Course(coursePrefix + " "
								+ courseNumber + coursePostfix, building,
								roomNumber + roomPostfix, professor, startHour
										+ ":" + startMinute + " " + startAmPm,
								endHour + ":" + endMinute + " " + endAmPm, days);

						updateCourseList(course);

						// Reset the page adapter to reload the Schedule
						// fragment
						mViewPager.setAdapter(new SectionsPagerAdapter(
								getSupportFragmentManager()));
